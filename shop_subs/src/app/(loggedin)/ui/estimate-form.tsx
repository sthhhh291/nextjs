...
import { SelectContent,Select,SelectLabel,SelectTrigger, SelectValue,SelectGroup, SelectItem } from "@/components/ui/select";
...
export default function EstimateForm(params: {
  ...
  // employees. change to pull from database later
  const employees = [
    {value:1,label:"Chuck"},
    {value:2,label:"Karen"},
    {value:3,label:"Brian"},
